 ...
 *
 * <p>This class, {@link MinimalPageRankArla}, is the first in a series of four successively more
...
public class MinimalPageRanknuvvala {
  ...
  public static void main(String[] args) {
    ...
    //.apply(
          ...
          //     .via((String linkline) -> Arrays.asList(linkline.strip())))
    ...
    //PCollectionKV<String> pcolKVpairsJob1 = pcolLinkLines.apply(
        ...
        pcolLinks.apply(TextIO.write().to("Manoj"));
